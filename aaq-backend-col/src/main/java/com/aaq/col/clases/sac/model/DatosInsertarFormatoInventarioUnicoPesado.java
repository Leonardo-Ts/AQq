...
public class DatosInsertarFormatoInventarioUnicoPesado {
	String inp_folio_e;
	 String inp_serie;
	 String inp_color;
	 String inp_placas;
	String inp_num_reporte;
	String inp_num_siniestro;
	String inp_num_poliza;
	String inp_num_asegurado;
	String inp_nombre_afectado;
	String inp_llaves;
	String inp_fecha;
	String inp_num_endoso;
	String inp_num_inciso;
	String inp_marca;
	String inp_tipo;
	String inp_puertas;
	String inp_modelo;
	String inp_num_motor;
	String inp_kilometraje;
	String inp_combustible;
	String inp_correo;
	String inp_tractocamion_pieza;
	String inp_originales_camion;
	String inp_renovadas_camion;
	String inp_daniadas_camion;
	String inp_faltantes_camion;
	String inp_daniadas_remolque;
	String inp_faltantes_remolque;
	String inp_nombre_conductor;
	String inp_nombre_operador_grua;
	String inp_caso1_fecha;
	String inp_caso1_lugar;
	String inp_caso1_observaciones;
	String inp_caso1_nom_entrega;
	String inp_caso1_nom_recibe;
	String inp_caso2_fecha;
	String inp_caso2_lugar;
	String inp_caso2_observaciones;
	String inp_caso2_nom_entrega;
	String inp_caso2_nom_recibe;
	String inp_caso3_fecha;
	String inp_caso3_lugar;
	String inp_caso3_observaciones;
	String inp_caso3_nom_entrega;
	String inp_caso3_nom_recibe;
	String firma_ajustador;
	String firma_conductor;
	String firma_operador_grua;
	String firma_caso1_entrega;
	String firma_caso1_recibe;
	String firma_caso2_entrega;
	String firma_caso2_recibe;
	String firma_caso3_entrega;
	String firma_caso3_recibe;
	String inp_nom_ajustador;
	String inp_clave_ajustador;
	String check_1;
	String check_2;
	String check_3;
	String check_4;
	...
	String inp_correo_grua;
	String inp_correo_taller;
	String inp_caso_1_ubicacion_flecha;
	String inp_caso_1_a_lugar;
	String inp_caso_1_prestador;
	String inp_caso_1_danios_faltantes;
	String inp_caso_1_crucero;
	String inp_caso_1_taller;
	String inp_caso_1_mp;
	String inp_caso_1_ajustador;
	String inp_caso_2_ubicacion_flecha;
	String inp_caso_2_a_lugar;
	String inp_caso_2_prestador;
	String inp_caso_2_danios_faltantes;
	String inp_caso_2_crucero;
	String inp_caso_2_taller;
	String inp_caso_2_mp;
	String inp_caso_2_ajustador;
	String inp_caso_3_ubicacion_flecha;
	String inp_caso_3_a_lugar;
	String inp_caso_3_prestador;
	String inp_caso_3_danios_faltantes;
	String inp_caso_3_crucero;
	String inp_caso_3_taller;
	String inp_caso_3_mp;
	String inp_caso_3_ajustador;
	String inp_nom_entrega_gral;
	String inp_nom_recibe_gral;
	String firma_recibe_gral;
	String firma_entrega_gral;
	...
	public String getInp_llaves() {
		return inp_llaves;
	}
	public void setInp_llaves(String inp_llaves) {
		this.inp_llaves = inp_llaves;
	}
	public String getInp_fecha() {
		return inp_fecha;
	}
	public void setInp_fecha(String inp_fecha) {
	...
	public String getInp_combustible() {
		return inp_combustible;
	}
	public void setInp_combustible(String inp_combustible) {
	...
	public String getInp_caso1_fecha() {
		return inp_caso1_fecha;
	}
	public void setInp_caso1_fecha(String inp_caso1_fecha) {
	...
	public String getInp_caso2_fecha() {
		return inp_caso2_fecha;
	}
	public void setInp_caso2_fecha(String inp_caso2_fecha) {
	...
	public String getInp_caso3_fecha() {
		return inp_caso3_fecha;
	}
	public void setInp_caso3_fecha(String inp_caso3_fecha) {
	...
	public String getInp_caso_1_ubicacion_flecha() {
		return inp_caso_1_ubicacion_flecha;
	}
	public void setInp_caso_1_ubicacion_flecha(String inp_caso_1_ubicacion_flecha) {
	...
	public String getInp_caso_2_ubicacion_flecha() {
		return inp_caso_2_ubicacion_flecha;
	}
	public void setInp_caso_2_ubicacion_flecha(String inp_caso_2_ubicacion_flecha) {
	...
	public String getInp_caso_3_ubicacion_flecha() {
		return inp_caso_3_ubicacion_flecha;
	}
	public void setInp_caso_3_ubicacion_flecha(String inp_caso_3_ubicacion_flecha) {
