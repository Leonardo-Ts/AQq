...
public interface FormatoAdmisionAutomovilesDaoInterfase
		extends JMRepositorioGenericoInterfase<FormatoAdmisionAutomoviles> {
	...
	public abstract String InsertarFormatoAdmisionAutomoviles(DatosInsertarFormatoAdmisionAutomoviles entrada);
	public abstract String ejecutarFuncionWebserviceStoreFAAuto(Map<String, String> entry);
