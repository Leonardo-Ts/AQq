...
public interface FormatoCuestionarioRoboDaoInterfase extends JMRepositorioGenericoInterfase<FormatoCuestionarioRobo> {
	...
	public abstract String ejecutarFuncionInsertarCuestionarioRobo(
	...
	public abstract String InsertarFormatoCuestionarioRobo(DatosInsertarFormatoCuestionarioRobo entrada);
	public abstract String ejecutarFuncionWebserviceStoreFCR(Map<String, String> entry);
