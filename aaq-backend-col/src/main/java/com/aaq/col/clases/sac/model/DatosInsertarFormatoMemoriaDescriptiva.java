...
public class DatosInsertarFormatoMemoriaDescriptiva {
	 ...
	 private String gruaLugar;
	 private String concesion;
	 private String estatalFede;
	 private String maniobras;	
	 private String tipoGrua;
	 private String otraGrua;
	 private String otraGruaTexto;
	 private String cardan1;
	 private String cardan2;
	 private String cardan3;
	 private String cantidadGruas;
	 private String traspaleo;	
	 ...
	 private String camionToneladas;
	 private String horarioSolicitado;
	 private String horarioArribo;
	 private String horarioTraslado;
	 private String manEspeciales;	
	 private String servicioDesacoplar;
	 private String servicioAbanderaM;
	 private String servicioAbanderaG;
	 private String manualHora;
	 private String gruaHora;
	 private String servicioEnganche;
	 private String servicioFueraC;
	 private String servicioSobreC;
	 private String servicioVolcadura;	
	 private String servicioCarga;
	 private String servicioRescate;
	 private String servicioCustodia;
	 private String servicioManiobra;	
	...
	public DatosInsertarFormatoMemoriaDescriptiva() {
		super();
	}
	...
	public String getGruaLugar() {
		return gruaLugar;
	}


	public void setGruaLugar(String gruaLugar) {
	...
	public String getEstatalFede() {
		return estatalFede;
	}


	public void setEstatalFede(String estatalFede) {
	...
	public String getOtraGrua() {
		return otraGrua;
	}


	public void setOtraGrua(String otraGrua) {
	...
	public String getCardan1() {
		return cardan1;
	}


	public void setCardan1(String cardan1) {
		this.cardan1 = cardan1;
	}


	public String getCardan2() {
		return cardan2;
	}


	public void setCardan2(String cardan2) {
		this.cardan2 = cardan2;
	}


	public String getCardan3() {
		return cardan3;
	}


	public void setCardan3(String cardan3) {
	...
	public String getTraspaleo() {
		return traspaleo;
	}


	public void setTraspaleo(String traspaleo) {
	...
	public String getCamionToneladas() {
		return camionToneladas;
	}


	public void setCamionToneladas(String camionToneladas) {
	...
	public String getServicioDesacoplar() {
		return servicioDesacoplar;
	}


	public void setServicioDesacoplar(String servicioDesacoplar) {
		this.servicioDesacoplar = servicioDesacoplar;
	}


	public String getServicioAbanderaM() {
		return servicioAbanderaM;
	}


	public void setServicioAbanderaM(String servicioAbanderaM) {
		this.servicioAbanderaM = servicioAbanderaM;
	}


	public String getServicioAbanderaG() {
		return servicioAbanderaG;
	}


	public void setServicioAbanderaG(String servicioAbanderaG) {
	...
	public String getServicioEnganche() {
		return servicioEnganche;
	}


	public void setServicioEnganche(String servicioEnganche) {
		this.servicioEnganche = servicioEnganche;
	}


	public String getServicioFueraC() {
		return servicioFueraC;
	}


	public void setServicioFueraC(String servicioFueraC) {
		this.servicioFueraC = servicioFueraC;
	}


	public String getServicioSobreC() {
		return servicioSobreC;
	}


	public void setServicioSobreC(String servicioSobreC) {
		this.servicioSobreC = servicioSobreC;
	}


	public String getServicioVolcadura() {
		return servicioVolcadura;
	}


	public void setServicioVolcadura(String servicioVolcadura) {
	...
	public String getServicioRescate() {
		return servicioRescate;
	}


	public void setServicioRescate(String servicioRescate) {
		this.servicioRescate = servicioRescate;
	}


	public String getServicioCustodia() {
		return servicioCustodia;
	}


	public void setServicioCustodia(String servicioCustodia) {
		this.servicioCustodia = servicioCustodia;
	}


	public String getServicioManiobra() {
		return servicioManiobra;
	}


	public void setServicioManiobra(String servicioManiobra) {
