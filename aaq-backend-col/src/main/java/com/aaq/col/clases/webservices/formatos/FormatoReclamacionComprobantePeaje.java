...
@XmlRootElement
public class FormatoReclamacionComprobantePeaje {
	String rcp_num_reporte;
	String rcp_num_siniestro;
	String rcp_num_poliza;
	String rcp_num_asegurado;
	String rcp_nom_usuario;
	String rcp_sexo_usuario;
	String rcp_edad_usuario;
	String rcp_estado_civil_usuario;
	String rcp_ocupacion_usuario;
	String rcp_telefono_usuario;
	String rcp_correo_usuario;
	String rcp_calle_usuario;
	String rcp_colonia_usuario;
	String rcp_cp_usuario;
	String rcp_estado_usuario;
	String rcp_poblacion_usuario;
	String rcp_delegacion_usuario;
	String rcp_calle_oficina;
	String rcp_colonia_oficina;
	String rcp_cp_oficina;
	String rcp_estado_oficina;
	String rcp_poblacion_oficina;
	String rcp_delegacion_oficina;
	String rcp_razon_circula_auto;
	String rcp_fecha_siniestro;
	String rcp_marca_vehiculo;
	String rcp_vehiculo_propio;
	String rcp_licencia;
	String rcp_origen_viaje;
	String rcp_destino_viaje;
	String rcp_motivo_no_comprob;
	String rcp_nom_ajustador;
	String rcp_clave_ajustador;
	String rcp_nom_administracion;
	String rcp_testigo_1;
	String rcp_testigo_2;
	String rcp_pago_previo_peaje;
	String rcp_nom_plaza_1;
	String rcp_nom_plaza_2;
	String rcp_cantidad_plaza_1;
	String rcp_cantidad_plaza_2;
	String rcp_frecuencia_circula;
	String rcp_tarjeta_iave;
	String rcp_pago_tarjeta_credito;
	String rcp_via_ingreso;
	String rcp_motivo_danio;
	String rcp_causa_meteorologica;
	String rcp_causa_evento;
	String rcp_ingirio_sustancia;
	String rcp_vehiculo_asegurado;
	String rcp_vehiculo_asegurado_poliza;
	String rcp_vehiculo_asegurado_compania;
	String rcp_anexo_identificacion;
	String rcp_anexo_licencia;
	String rcp_anexo_narracion;
	String rcp_nom_testigo;
	String rcp_relacion_testigo;
	String rcp_telefono_testigo;
	String rcp_calle_testigo;
	String rcp_colonia_testigo;
	String rcp_cp_testigo;
	String rcp_estado_testigo;
	String rcp_poblacion_testigo;
	String rcp_delegacion_testigo;
	String rcp_declaracion_testigo;
	String check_1;
	String check_2;
	String check_3;
	String check_4;
	String firma_ajustador;
	String firma_administracion;
	String firma_usuario;
	String firma_testigo1;
	String firma_testigo2;
	...
	public String getRcp_razon_circula_auto() {
		return rcp_razon_circula_auto;
	}
	public void setRcp_razon_circula_auto(String rcp_razon_circula_auto) {
		this.rcp_razon_circula_auto = rcp_razon_circula_auto;
	}
	public String getRcp_fecha_siniestro() {
		return rcp_fecha_siniestro;
	}
	public void setRcp_fecha_siniestro(String rcp_fecha_siniestro) {
	...
	public String getRcp_vehiculo_propio() {
		return rcp_vehiculo_propio;
	}
	public void setRcp_vehiculo_propio(String rcp_vehiculo_propio) {
	...
	public String getRcp_pago_previo_peaje() {
		return rcp_pago_previo_peaje;
	}
	public void setRcp_pago_previo_peaje(String rcp_pago_previo_peaje) {
	...
	public String getRcp_tarjeta_iave() {
		return rcp_tarjeta_iave;
	}
	public void setRcp_tarjeta_iave(String rcp_tarjeta_iave) {
	...
	public String getRcp_causa_meteorologica() {
		return rcp_causa_meteorologica;
	}
	public void setRcp_causa_meteorologica(String rcp_causa_meteorologica) {
		this.rcp_causa_meteorologica = rcp_causa_meteorologica;
	}
	public String getRcp_causa_evento() {
		return rcp_causa_evento;
	}
	public void setRcp_causa_evento(String rcp_causa_evento) {
		this.rcp_causa_evento = rcp_causa_evento;
	}
	public String getRcp_ingirio_sustancia() {
		return rcp_ingirio_sustancia;
	}
	public void setRcp_ingirio_sustancia(String rcp_ingirio_sustancia) {
		this.rcp_ingirio_sustancia = rcp_ingirio_sustancia;
	}
	public String getRcp_vehiculo_asegurado() {
		return rcp_vehiculo_asegurado;
	}
	public void setRcp_vehiculo_asegurado(String rcp_vehiculo_asegurado) {
