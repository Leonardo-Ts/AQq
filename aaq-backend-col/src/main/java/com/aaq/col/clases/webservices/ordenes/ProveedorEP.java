...
public class ProveedorEP {
	 ...
	 */
	public void setResponsableTaller(String responsableTaller) {
	 ...
	 */
	public void setDomicilioTaller(String domicilioTaller) {
