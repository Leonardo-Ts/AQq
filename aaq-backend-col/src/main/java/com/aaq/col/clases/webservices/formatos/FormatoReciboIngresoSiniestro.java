...
@XmlRootElement
public class FormatoReciboIngresoSiniestro {	
	private String riNumSiniestro;
	private String  riFolio;
	private String  riFecha;
	...
	public String getRiFecha() {
		return riFecha;
	}


	public void setRiFecha(String riFecha) {
	...
	public String getRiValores() {
		return riValores;
	}


	public void setRiValores(String riValores) {
	...
	public void setRiFirmaAsegurado(String riFirmaAsegurado) {
		this.riFirmaAsegurado = riFirmaAsegurado;
	}
	...
	public void setRiFirmaTercero(String riFirmaTercero) {
		this.riFirmaTercero = riFirmaTercero;
	}
	...
	public void setRiFirmaAjustador(String riFirmaAjustador) {
		this.riFirmaAjustador = riFirmaAjustador;
	}
	...
	public void setRiFirmaRecibido(String riFirmaRecibido) {
		this.riFirmaRecibido = riFirmaRecibido;
	}
	...
	public void setRiNomTercero(String riNomTercero) {
		this.riNomTercero = riNomTercero;
	}
	...
	public void setRiNomAsegurado(String riNomAsegurado) {
		this.riNomAsegurado = riNomAsegurado;
	}
