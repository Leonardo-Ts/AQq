...
/**
 * AbstractFrecuencia entity provides the base persistence definition of the
 * Frecuencia entity. @author MyEclipse Persistence Tools
 */

@Access(AccessType.FIELD)
@MappedSuperclass
public abstract class AbstractFrecuencia extends JMEntidad {
