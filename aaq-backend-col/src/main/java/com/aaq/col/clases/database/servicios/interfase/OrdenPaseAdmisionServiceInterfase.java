...
public interface OrdenPaseAdmisionServiceInterfase extends JMServicioGenericoInterfase<OrdenPaseAdmision> {

	public abstract OrdenPaseAdmision objetoOrdenPaseAdmision(final String id);
	public abstract JMResultadoOperacion guardarObjeto(OrdenPaseAdmision t);
	public abstract List<OrdenPaseAdmision> listaDeOrdenPaseAdmision();
	public abstract String ejecutarFuncionInsertarPaseAdmision(String usuario, String passwd, String reporte,
			Date fechaHora, String tipoOrden, String tipoAfectado, String conductor, String telefonoConductor,
			String oficina, String ubicacion, String tipoProveedor, String claveProveedor, String responsableTaller,
