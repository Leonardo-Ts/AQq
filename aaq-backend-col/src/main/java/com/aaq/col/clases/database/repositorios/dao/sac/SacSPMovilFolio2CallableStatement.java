...
public class SacSPMovilFolio2CallableStatement implements CallableStatementCreator {
	...
	public SacSPMovilFolio2CallableStatement(Map<String, Object> entry) {
		this.entry = entry;
	}
	...
	public CallableStatement createCallableStatement(Connection con) throws SQLException {
		...
		try {
			this.historicoTerminalServiceInterfase.ejecutarFuncionHistoricoTerminal(null,null, (String) entry.get("dmReporte"),
