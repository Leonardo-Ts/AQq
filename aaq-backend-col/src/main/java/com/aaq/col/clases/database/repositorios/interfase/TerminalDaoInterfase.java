...
public interface TerminalDaoInterfase extends JMRepositorioGenericoInterfase<Terminal> {
	...
	public abstract JMResultadoOperacion ejecutarFuncionTerminalEstatus(Integer id, String estatus,
			String fuenteOperacion, String fuente, String numeroProveedor, String fuenteEstatus);
	...
	public abstract List<Terminal> listaTodoDeTerminal();
	public abstract List<Terminal> listaTodoDeTerminal(Boolean esReporteApartado);
	public abstract EstadisticaMonitorDataModel obtenerEstadisticas(Integer idEntidad, Integer idBase);
	public abstract EstadisticaMonitorDataModel obtenerEstadisticasFrecuencia(Integer idEntidad, String idBases);
	...
	public abstract List<Terminal> listarDeAjustadores(final Estado estado, final Base base, final String estatus);
	public abstract Terminal obtenerTerminal(final String numeroProveedor, final String passwd );
	public abstract JMResultadoOperacion ejecutarIntercambioReporte(String numeroProveedorA, String numeroReporteA,
