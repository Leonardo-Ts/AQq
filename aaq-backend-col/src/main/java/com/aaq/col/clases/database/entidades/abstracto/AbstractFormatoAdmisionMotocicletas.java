...
import com.jmfg.jmlib.sistema.classes.dao.entidad.JMEntidad;
 ...
 @MappedSuperclass
 public abstract class AbstractFormatoAdmisionMotocicletas extends JMEntidad {

	private static final long serialVersionUID = 5473717999158319092L;

	@SequenceGenerator(name = "opAdmisionMotosSEQ", sequenceName = "formato_admision_motocicletas_seq", allocationSize = 1)
	 @Id
	 @Column(name = "OA_ID")
	 @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "opAdmisionMotosSEQ")
	 private Integer id;
	...
	/** default constructor */
	public AbstractFormatoAdmisionMotocicletas() {
		super();
	}
