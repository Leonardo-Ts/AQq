...
public class MovilReporte {
	...
	public MovilReporte(final String resultado, final ReporteSise reporteSise, final ReporteMovilSac reporteSac, final boolean esAjustadorVulnerable) {
...
//					,reporteSac.getGeneralPolizaEstatus());			
		...
		if ((this.reporte != null)) {
			...
			if (StringUtils.isNotBlank(reporteSac.getGeneralNumeroReporte())) {
				...
				try {
					lista = MovilReporte.reporteMovilSacTalleresDao.listaDeReporteMovilSacTalleres(reporteSac.getGeneralNumeroReporte(), reporteSac.getAjusteAjustadorCodigo());
			...
			if (StringUtils.isNotBlank(reporteSac.getGeneralNumeroReporte())) {
				...
				try {
					lista = MovilReporte.reporteMovilSacTercerosDao.listaDeReporteMovilSacTerceros(reporteSac.getGeneralNumeroReporte(), reporteSac.getAjusteAjustadorCodigo());
				} catch (final Exception ex) {
			...
			if (StringUtils.isNotBlank(reporteSac.getGeneralNumeroReporte())) {
				...
				try {
					lista = MovilReporte.reporteMovilSacGruasDao.listaDeReporteMovilSacGruas(reporteSac.getGeneralNumeroReporte(), reporteSac.getAjusteAjustadorCodigo());
				} catch (final Exception ex) {
