...
public class MovilServicioEncuesta {
	...
	private Integer servicioDeGrua;
	...
	/**
	 * @param numeroDeReporte the numeroDeReporte to set
	 */
	public void setNumeroDeReporte(final String numeroDeReporte) {
	 ...
	 */
	public Integer getAtencionPersonalCabina() {
	 ...
	 */
	public void setAtencionPersonalCabina(final Integer atencionPersonalCabina) {
	 ...
	 */
	public Integer getLlegadaAjustador() {
	 ...
	 */
	public void setLlegadaAjustador(final Integer llegadaAjustador) {
	 ...
	 */
	public Integer getPresentacionAjustador() {
	 ...
	 */
	public void setPresentacionAjustador(final Integer presentacionAjustador) {
	 ...
	 */
	public Integer getTratoAjustador() {
	 ...
	 */
	public void setTratoAjustador(final Integer tratoAjustador) {
	 ...
	 */
	public Integer getCapacidadAjustador() {
	 ...
	 */
	public void setCapacidadAjustador(final Integer capacidadAjustador) {
	 ...
	 */
	public Integer getTratoAjustadorTercero() {
	 ...
	 */
	public void setTratoAjustadorTercero(final Integer tratoAjustadorTercero) {
		this.tratoAjustadorTercero = tratoAjustadorTercero;
	}

	/**
	 * @return the servicioDeGrua
	 */
	public Integer getServicioDeGrua() {
		return this.servicioDeGrua;
	}

	/**
	 * @param servicioDeGrua the servicioDeGrua to set
	 */
	public void setServicioDeGrua(final Integer servicioDeGrua) {
		this.servicioDeGrua = servicioDeGrua;
	}

	/**
	 * @return the seleccionDeTaller
	 */
	public Integer getSeleccionDeTaller() {
	 ...
	 */
	public void setSeleccionDeTaller(final Integer seleccionDeTaller) {
	 ...
	 */
	public Boolean getObservoIrregularidadServicio() {
	 ...
	 */
	public void setObservoIrregularidadServicio(final Boolean observoIrregularidadServicio) {
	 ...
	 */
	public Boolean getRecibioCopiaDA() {
	 ...
	 */
	public void setRecibioCopiaDA(final Boolean recibioCopiaDA) {
	 ...
	 */
	public void setCorreoConductor(final String correoConductor) {
