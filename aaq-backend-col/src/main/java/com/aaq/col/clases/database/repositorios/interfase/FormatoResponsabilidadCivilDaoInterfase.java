...
public interface FormatoResponsabilidadCivilDaoInterfase
		extends JMRepositorioGenericoInterfase<FormatoResponsabilidadCivil> {
	...
	public abstract String InsertarFormatoResponsabilidadCivil(DatosInsertarFormatoResponsabilidadCivil entrada);
	public abstract String ejecutarFuncionWebserviceStoreFRC(Map<String, String> entry);
