...
public class ServicioFormatosAdmisionAutomoviles {
	...
	private boolean oaDanioMenor;
	
	private Integer oa_producto_esencial;
	...
	public boolean isOaDanioMenor() {
		return oaDanioMenor;
	}

	public void setOaDanioMenor(boolean oaDanioMenor) {
		this.oaDanioMenor = oaDanioMenor;
	}

	public Integer getOa_producto_esencial() {
		return oa_producto_esencial;
	}

	public void setOa_producto_esencial(Integer oa_producto_esencial) {
