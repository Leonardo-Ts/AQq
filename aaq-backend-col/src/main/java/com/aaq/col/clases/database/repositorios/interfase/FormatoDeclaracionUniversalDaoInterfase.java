...
public interface FormatoDeclaracionUniversalDaoInterfase
		extends JMRepositorioGenericoInterfase<FormatoDeclaracionUniversal> {
	...
	public abstract String ejecutarFuncionInsertarDeclaracionUniversal(
	...
	public abstract String InsertarFormatoDeclaracionUniversal(DatosInsertarFormatoDeclaracionUniversal entrada);
	public abstract String ejecutarFuncionWebserviceStoreFDU(Map<String, String> entry);
